...
public class MysqlGenerator {
    ...
    public static void mysqlGer() {
        ...
        pc.setParent("com.start.mb.boot");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称 com.start.mb.boot.persistence.
                if (StringUtils.isEmpty(pc.getModuleName())) {
                    return projectPath + "/src/main/resources/com/start/mb/boot/persistence/mapper/"
